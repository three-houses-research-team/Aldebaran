...
for dir in dirs:
    if dir.startswith("aldebaran_patch_"):
...
ensuredirectory(ftp, '/atmosphere/contents', "010055D009F78000")
ensuredirectory(ftp, f'/atmosphere/contents/010055D009F78000', 'exefs')

binaryPath = f'{os.path.basename(os.getcwd())}{version}.nso'
if os.path.isfile(binaryPath):
    sdPath = f'/atmosphere/contents/010055D009F78000/exefs/subsdk2'
    print(f'Sending {sdPath}')
    ftp.storbinary(f'STOR {sdPath}', open(binaryPath, 'rb'))

metaPath = f'feth.npdm'
sdPath = '/atmosphere/contents/010055D009F78000/exefs/main.npdm'
print(f'Sending {sdPath}')
ftp.storbinary('STOR /atmosphere/contents/010055D009F78000/exefs/main.npdm', open(metaPath, 'rb'))